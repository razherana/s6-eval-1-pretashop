...
class __TwigTemplate_0575596fdbb3d88c67786128d7bf181a extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"card-body\">
          ...
          ";
            ...
            ";
            // line 72
            echo $this->extensions['PrestaShopBundle\Twig\RawPurifiedExtension']->rawPurifier($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Read the [1]developer documentation[/1].", ["[1]" => (("<a href=\"" .             // line 73
