...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  array (
    'Refund has been processed by PayPal.' => 'Refund has been processed by PayPal.',
    'Refund cannot be processed by PayPal.' => 'Refund cannot be processed by PayPal.',
    'Refund has been processed by PayPal, but order status change or email sending failed.' => 'Refund has been processed by PayPal, but order status change or email sending failed.',
    'PayPal refund failed.' => 'PayPal refund failed.',
    'PayPal refund amount is invalid.' => 'PayPal refund amount is invalid.',
    'PayPal refund currency is invalid.' => 'PayPal refund currency is invalid.',
    'PayPal Transaction is invalid.' => 'PayPal Transaction is invalid.',
    'PayPal Order is invalid.' => 'PayPal Order is invalid.',
    ...
    'No PrestaShop Order identifier received' => 'No PrestaShop Order identifier received',
    'Provide the most commonly used payment methods to your customers in this all-in-one module, and manage all your sales in a centralized interface.' => 'Provide the most commonly used payment methods to your customers in this all-in-one module, and manage all your sales in a centralized interface.',
    'PrestaShop Checkout' => 'PrestaShop Checkout',
    'The payer did not authorize the payment.' => 'The payer did not authorize the payment.',
    'The payer paid for an item that they did not receive.' => 'The payer paid for an item that they did not receive.',
    'For more information, please go to the official PayPal website.' => 'For more information, please go to the official PayPal website.',
    'Dispute categories covered:' => 'Dispute categories covered:',
    'Your PayPal balance is not protected, the transaction is not eligible to the seller protection program.' => 'Your PayPal balance is not protected, the transaction is not eligible to the seller protection program.',
    'Your PayPal balance remains intact if the customer claims that they did not receive an item.' => 'Your PayPal balance remains intact if the customer claims that they did not receive an item.',
    'Your PayPal balance remains intact if the customer claims that they did not receive an item or the account holder claims that they did not authorize the payment.' => 'Your PayPal balance remains intact if the customer claims that they did not receive an item or the account holder claims that they did not authorize the payment.',
    'Not eligible' => 'Not eligible',
    'Partially eligible' => 'Partially eligible',
    'Eligible' => 'Eligible',
    'You are not authorized to refund this order.' => 'You are not authorized to refund this order.',
    'Refund' => 'Refund',
    'Payment' => 'Payment',
    'Total' => 'Total',
    'was not saved for future purchases' => 'was not saved for future purchases',
    'was saved for future purchases' => 'was saved for future purchases',
    'Payment method status' => 'Payment method status',
    'If you have any question, please contact us.' => 'If you have any question, please contact us.',
    'You will be redirected to an external secured page of our payment gateway.' => 'You will be redirected to an external secured page of our payment gateway.',
    'Your payment needs to be authenticated, please click the button below.' => 'Your payment needs to be authenticated, please click the button below.',
    'Your payment needs to be approved, please click the button below.' => 'Your payment needs to be approved, please click the button below.',
    'Your payment has been declined by our payment gateway, please contact us via the link below.' => 'Your payment has been declined by our payment gateway, please contact us via the link below.',
    ...
    'If you need assistance, please contact our Support Team on PrestaShop Checkout configuration page on Help subtab.' => 'If you need assistance, please contact our Support Team on PrestaShop Checkout configuration page on Help subtab.',
    'Exception detail:' => 'Exception detail:',
    'Exception identifier:' => 'Exception identifier:',
    'PayPal order identifier:' => 'PayPal order identifier:',
    'Cart identifier:' => 'Cart identifier:',
    'Customer identifier:' => 'Customer identifier:',
    'A customer encountered a processing payment error :' => 'A customer encountered a processing payment error :',
    'This message is sent automatically by module PrestaShop Checkout' => 'This message is sent automatically by module PrestaShop Checkout',
    'This payment method has been refused by the payment platform, please use another payment method.' => 'This payment method has been refused by the payment platform, please use another payment method.',
    'Order is already captured.' => 'Order is already captured.',
    'Transaction expired, please try again.' => 'Transaction expired, please try again.',
    'The transaction failed. Please try a different payment method.' => 'The transaction failed. Please try a different payment method.',
    'Your country is not supported by this payment method, please try to select another.' => 'Your country is not supported by this payment method, please try to select another.',
    'Your card cannot be used to pay in this currency, please try another payment method.' => 'Your card cannot be used to pay in this currency, please try another payment method.',
    'The CVC code length is invalid for the specified card type.' => 'The CVC code length is invalid for the specified card type.',
    'Processing of this card type is not supported. Use another card type.' => 'Processing of this card type is not supported. Use another card type.',
    'Cart delivery option is unavailable.' => 'Cart delivery option is unavailable.',
    'Cart delivery address is invalid.' => 'Cart delivery address is invalid.',
    'Cart invoice address is invalid.' => 'Cart invoice address is invalid.',
    'Cart contains product unavailable.' => 'Cart contains product unavailable.',
    'Cart doesn\'t contains product.' => 'Cart doesn\'t contains product.',
    'The transaction amount doesn\'t match with the cart amount.' => 'The transaction amount doesn\'t match with the cart amount.',
    'OrderPayment cannot be saved' => 'OrderPayment cannot be saved',
    'OrderState cannot be saved' => 'OrderState cannot be saved',
    'Order cannot be saved' => 'Order cannot be saved',
    'Cart is invalid' => 'Cart is invalid',
    'PayPal payment method is missing' => 'PayPal payment method is missing',
    'PayPal order identifier is missing' => 'PayPal order identifier is missing',
    'Unable to call API' => 'Unable to call API',
    'This payment method is unavailable' => 'This payment method is unavailable',
    'The transaction was refused.' => 'The transaction was refused.',
    'The transaction failed. Please try a different card.' => 'The transaction failed. Please try a different card.',
    'Error processing payment, you could have been charged. Please check your order history in your account to check the status of the order or please contact our customer service to know more.' => 'Error processing payment, you could have been charged. Please check your order history in your account to check the status of the order or please contact our customer service to know more.',
    'We encountered an issue while processing your Apple Pay payment. Please verify your order details and try again, or use a different payment method.' => 'We encountered an issue while processing your Apple Pay payment. Please verify your order details and try again, or use a different payment method.',
    'We’re unable to process your Apple Pay payment at the moment. This could be due to an issue verifying the payment setup for this website. Please try again later or choose a different payment method.' => 'We’re unable to process your Apple Pay payment at the moment. This could be due to an issue verifying the payment setup for this website. Please try again later or choose a different payment method.',
    'Card holder authentication cannot be checked, please choose another payment method or try again.' => 'Card holder authentication cannot be checked, please choose another payment method or try again.',
    'Card holder authentication failed, please choose another payment method or try again.' => 'Card holder authentication failed, please choose another payment method or try again.',
    'An error occurred on card holder authentication, please choose another payment method or try again.' => 'An error occurred on card holder authentication, please choose another payment method or try again.',
    'Card holder authentication canceled, please choose another payment method or try again.' => 'Card holder authentication canceled, please choose another payment method or try again.',
    'An error occurred fetching Apple Pay payment request' => 'An error occurred fetching Apple Pay payment request',
    'An error occurred fetching Google Pay transaction info' => 'An error occurred fetching Google Pay transaction info',
    'No Apple Pay Javascript SDK Instance' => 'No Apple Pay Javascript SDK Instance',
    'No Google Pay Javascript SDK Instance' => 'No Google Pay Javascript SDK Instance',
    'No PayPal Javascript SDK Instance' => 'No PayPal Javascript SDK Instance',
    'There was an error during the payment. Please try again or contact the support.' => 'There was an error during the payment. Please try again or contact the support.',
    'Failed' => 'Failed',
    'Refunded' => 'Refunded',
    ...
    'Pay by %s' => 'Pay by %s',
    'Pay in installments with PayPal Pay Later' => 'Pay in installments with PayPal Pay Later',
    'Pay with a PayPal account' => 'Pay with a PayPal account',
    'Pay by Card - 100% secure payments' => 'Pay by Card - 100% secure payments',
    'Card' => 'Card',
    'Go back to the Checkout' => 'Go back to the Checkout',
    'Checkout' => 'Checkout',
    'Card payment' => 'Card payment',
    'Order summary' => 'Order summary',
    'Your shopping cart is empty.' => 'Your shopping cart is empty.',
    'PayPal' => 'PayPal',
    'You have chosen to pay by Card.' => 'You have chosen to pay by Card.',
    'You have chosen to pay by PayPal.' => 'You have chosen to pay by PayPal.',
    'Here is a short summary of your order:' => 'Here is a short summary of your order:',
    'The total amount of your order comes to' => 'The total amount of your order comes to',
    '(tax incl.)' => '(tax incl.)',
    'Please confirm your order by clicking "I confirm my order".' => 'Please confirm your order by clicking "I confirm my order".',
    'Delete this payment method?' => 'Delete this payment method?',
    'The following payment method will be deleted from your account:' => 'The following payment method will be deleted from your account:',
    'Delete payment method' => 'Delete payment method',
    'Please wait, we are processing your request' => 'Please wait, we are processing your request',
    'Other payment methods' => 'Other payment methods',
    'I confirm my order' => 'I confirm my order',
    'Thanks for your purchase!' => 'Thanks for your purchase!',
    'Please wait, we are processing your payment' => 'Please wait, we are processing your payment',
    'This is taking longer than expected. Please wait...' => 'This is taking longer than expected. Please wait...',
    'Ok' => 'Ok',
    'Cancel' => 'Cancel',
    '100% secure payments' => '100% secure payments',
    'or' => 'or',
    'Express Checkout' => 'Express Checkout',
    'Unable to find PayPal Order associated to this PrestaShop Order [PRESTASHOP_ORDER_ID]' => 'Unable to find PayPal Order associated to this PrestaShop Order [PRESTASHOP_ORDER_ID]',
    'This PrestaShop Order [PRESTASHOP_ORDER_ID] is not paid with PrestaShop Checkout' => 'This PrestaShop Order [PRESTASHOP_ORDER_ID] is not paid with PrestaShop Checkout',
    'PayPal Order [PAYPAL_ORDER_ID] is not in the same environment as PrestaShop Checkout' => 'PayPal Order [PAYPAL_ORDER_ID] is not in the same environment as PrestaShop Checkout',
    'It seems your employee token is invalid.' => 'It seems your employee token is invalid.',
    'It seems you are logged out.' => 'It seems you are logged out.',
    'Your PayPal Merchant identifier seems invalid.' => 'Your PayPal Merchant identifier seems invalid.',
    'We didn\'t receive your PayPal Merchant identifier.' => 'We didn\'t receive your PayPal Merchant identifier.',
    'Environment' => 'Environment',
    'Test' => 'Test',
    'Transaction details are not available' => 'Transaction details are not available',
    'Seller protection' => 'Seller protection',
    'Refund transaction totally or partially' => 'Refund transaction totally or partially',
    'The environment in which the transaction was made: Test or Production' => 'The environment in which the transaction was made: Test or Production',
    'The bank issuer accepted the liability shift. You can safely honor the order.' => 'The bank issuer accepted the liability shift. You can safely honor the order.',
    'Transaction details' => 'Transaction details',
    'Your transaction refund request will be sent to PayPal. After that, you’ll need to manually process the refund action in the PrestaShop order: choose the type of refund (standard or partial) in order to generate credit slip.' => 'Your transaction refund request will be sent to PayPal. After that, you’ll need to manually process the refund action in the PrestaShop order: choose the type of refund (standard or partial) in order to generate credit slip.',
    'Success' => 'Success',
    'Fees (Tax Incl.)' => 'Fees (Tax Incl.)',
    'PayPal Order' => 'PayPal Order',
    'The bank issuer declined the liability shift. We advice you not to honor the order immediately, wait a few days in case of chargeback and contact the consumer to ensure authenticity of the transaction. For this type of cases we also recommend to consider Chargeback protection.' => 'The bank issuer declined the liability shift. We advice you not to honor the order immediately, wait a few days in case of chargeback and contact the consumer to ensure authenticity of the transaction. For this type of cases we also recommend to consider Chargeback protection.',
    'This PayPal Order has been reversed.' => 'This PayPal Order has been reversed.',
    'The PayPal account that was used to create this order is no longer linked to the PrestaShop Checkout module.' => 'The PayPal account that was used to create this order is no longer linked to the PrestaShop Checkout module.',
    'Reference' => 'Reference',
    'Exempted' => 'Exempted',
    'See on PayPal' => 'See on PayPal',
    'Production' => 'Production',
    'Any change on the order?' => 'Any change on the order?',
    'Gross amount' => 'Gross amount',
    'Net amount' => 'Net amount',
    'In order to see this information, please reconnect the correct PayPal account.' => 'In order to see this information, please reconnect the correct PayPal account.',
    'Your 3D Secure settings for this transaction were set to "Strong Customer Authentication (SCA) when required", but the current transaction does not require it as per the regulation.' => 'Your 3D Secure settings for this transaction were set to "Strong Customer Authentication (SCA) when required", but the current transaction does not require it as per the regulation.',
    'Merchant' => 'Merchant',
    'Balance' => 'Balance',
    'This PayPal Order has been canceled.' => 'This PayPal Order has been canceled.',
    'Amount (Tax incl.)' => 'Amount (Tax incl.)',
    'Total amount you will receive on your bank account: the order amount, minus transaction fees, minus potential refunds' => 'Total amount you will receive on your bank account: the order amount, minus transaction fees, minus potential refunds',
    'Go to PrestaShop Checkout' => 'Go to PrestaShop Checkout',
    'Learn more' => 'Learn more',
    'Transaction amounts' => 'Transaction amounts',
    'Maximum [AMOUNT_MAX] [CURRENCY] (Tax incl.)' => 'Maximum [AMOUNT_MAX] [CURRENCY] (Tax incl.)',
    'Amount (Tax Incl.)' => 'Amount (Tax Incl.)',
    ...
    'Status' => 'Status',
    '3D Secure' => '3D Secure',
    'Net amount to refund' => 'Net amount to refund',
    'Card does not support 3D Secure' => 'Card does not support 3D Secure',
    'Order details' => 'Order details',
    'Confirm refund' => 'Confirm refund',
    'Maximum [AMOUNT_MAX] [CURRENCY] (tax included)' => 'Maximum [AMOUNT_MAX] [CURRENCY] (tax included)',
    'Card holder name is invalid' => 'Card holder name is invalid',
    '3-digits' => '3-digits',
    'Card vendor is invalid' => 'Card vendor is invalid',
    'code on the back of your credit card. In some cases, it can be 4-digits or on the front of your card.' => 'code on the back of your credit card. In some cases, it can be 4-digits or on the front of your card.',
    'CVV code is invalid' => 'CVV code is invalid',
    'Card expiration date' => 'Card expiration date',
    'Card expiration date is invalid' => 'Card expiration date is invalid',
    'Card number is invalid' => 'Card number is invalid',
    'Cardholder Name (optional)' => 'Cardholder Name (optional)',
    'The security code is a' => 'The security code is a',
    'Go back to module configuration' => 'Go back to module configuration',
    'An error occurred on PayPal Onboarding, please try again.' => 'An error occurred on PayPal Onboarding, please try again.',
    'Your order is waiting for payment confirmation. You will receive an email when your payment has been validated. You can also check the order status in your order history in your account.' => 'Your order is waiting for payment confirmation. You will receive an email when your payment has been validated. You can also check the order status in your order history in your account.',
    'Your order is confirmed.' => 'Your order is confirmed.',
    'Processing payment canceled, please choose another payment method or try again.' => 'Processing payment canceled, please choose another payment method or try again.',
    'Pay by card' => 'Pay by card',
    'The customer must resolve the contingency before the payment can be processed.' => 'The customer must resolve the contingency before the payment can be processed.',
    'Order has previously been saved. Please contact customer service to check that your order has successfully been validated. ' => 'Order has previously been saved. Please contact customer service to check that your order has successfully been validated. ',
    'You skipped 3D Secure validation, please try again or try another payment method.' => 'You skipped 3D Secure validation, please try again or try another payment method.',
    'The merchant account is restricted. Please try later or contact customer service to process your order.' => 'The merchant account is restricted. Please try later or contact customer service to process your order.',
    'Please save the order by calling v2/orders/{order_id}/save or alternately, If you don\'t intend to save the order, PATCH the order to update the value of `processing_instruction` to NO_INSTRUCTION.' => 'Please save the order by calling v2/orders/{order_id}/save or alternately, If you don\'t intend to save the order, PATCH the order to update the value of `processing_instruction` to NO_INSTRUCTION.',
    'The requested agreement is already canceled. This error occurs when the agreement for an authorized payment or captured payment is already canceled.' => 'The requested agreement is already canceled. This error occurs when the agreement for an authorized payment or captured payment is already canceled.',
    'Authorization amount exceeds allowable limit. Please provide the authorization amount within allowable limit and try again.' => 'Authorization amount exceeds allowable limit. Please provide the authorization amount within allowable limit and try again.',
    'This order has been previously voided and cannot be voided again. Verify the order id and try again.' => 'This order has been previously voided and cannot be voided again. Verify the order id and try again.',
    'Card processing payment error, please try again or try another payment method.' => 'Card processing payment error, please try again or try another payment method.',
    'Payee account is not setup to be able to process card payments. Please contact PayPal customer support.' => 'Payee account is not setup to be able to process card payments. Please contact PayPal customer support.',
    'The value of a field is invalid.' => 'The value of a field is invalid.',
    'The card number, the expiry date or the CVV is invalid. Please verify all three and try again.' => 'The card number, the expiry date or the CVV is invalid. Please verify all three and try again.',
    ...
    'That transaction has been blocked by Fraud Protection rules. Please try another card or contact customer service to process your order or change their Fraud Protection rules.' => 'That transaction has been blocked by Fraud Protection rules. Please try another card or contact customer service to process your order or change their Fraud Protection rules.',
    'This transaction is currently not supported. Please contact customer service or your account manager for more information.' => 'This transaction is currently not supported. Please contact customer service or your account manager for more information.',
    'The number of items in an array parameter is too small.' => 'The number of items in an array parameter is too small.',
    'That currency is not supported with that payment option. Please try with another currency or contact customer support.' => 'That currency is not supported with that payment option. Please try with another currency or contact customer support.',
    '3D Secure validation failed, please try again or try another payment method.' => '3D Secure validation failed, please try again or try another payment method.',
    ...
    'Order does not have a corresponding matching reference_id. Please provide a valid reference_id and try again.' => 'Order does not have a corresponding matching reference_id. Please provide a valid reference_id and try again.',
    ...
    'Specified resource ID does not exist. Please check the resource ID and try again.' => 'Specified resource ID does not exist. Please check the resource ID and try again.',
    'Order already authorized. Only one authorization per order is allowed. Please contact customer service to check that your order has successfully been validated.' => 'Order already authorized. Only one authorization per order is allowed. Please contact customer service to check that your order has successfully been validated.',
    ...
    'A required parameter is missing. Please check that every personnal and delivery details are filled and try again.' => 'A required parameter is missing. Please check that every personnal and delivery details are filled and try again.',
    'Invalid order intent.' => 'Invalid order intent.',
    'The card is expired. Please use another card.' => 'The card is expired. Please use another card.',
    'Processing of this card brand is not supported. Use another type of card.' => 'Processing of this card brand is not supported. Use another type of card.',
    'Threeds Secure Parameters are empty.' => 'Threeds Secure Parameters are empty.',
    'Currency code not supported for direct card payments using this card type. Please refer https://developer.paypal.com/docs/integration/direct/rest/currency-codes/ for list of supported currency codes.' => 'Currency code not supported for direct card payments using this card type. Please refer https://developer.paypal.com/docs/integration/direct/rest/currency-codes/ for list of supported currency codes.',
    'Order already captured. Only one capture per order is allowed. Please contact customer service to check that your order has successfully been validated.' => 'Order already captured. Only one capture per order is allowed. Please contact customer service to check that your order has successfully been validated.',
    'Expiration year must be between now and 2099' => 'Expiration year must be between now and 2099',
    '3D Secure processing validation error, please try again or try another payment method.' => '3D Secure processing validation error, please try again or try another payment method.',
    'The API Caller account is not setup to be able to process card payments. Please contact PayPal customer support.' => 'The API Caller account is not setup to be able to process card payments. Please contact PayPal customer support.',
    'Processing of this card type is not supported. Use another type of card.' => 'Processing of this card type is not supported. Use another type of card.',
    'The transaction is declined due to a compliance violation.' => 'The transaction is declined due to a compliance violation.',
    'The client is not allowed to use `payment_instruction` object.' => 'The client is not allowed to use `payment_instruction` object.',
    ...
    'The customer has not approved payment.' => 'The customer has not approved payment.',
    ...
    'Invalid card number. Please verify the card number and try again.' => 'Invalid card number. Please verify the card number and try again.',
    'The shipping address is required. Please check that shipping address fields are completed and try again.' => 'The shipping address is required. Please check that shipping address fields are completed and try again.',
    ...
    'PrestaShop Checkout transactions won\'t work in some of your configured countries, but there is a solution !' => 'PrestaShop Checkout transactions won\'t work in some of your configured countries, but there is a solution !',
    'Change currencies activation for this payment module' => 'Change currencies activation for this payment module',
    'Change countries activation for this payment module' => 'Change countries activation for this payment module',
    'Please upgrade your settings for :' => 'Please upgrade your settings for :',
    'Know more about compliant ISO Codes' => 'Know more about compliant ISO Codes',
    'PrestaShop Checkout transactions won\'t work in some of your configured currencies, but there is a solution !' => 'PrestaShop Checkout transactions won\'t work in some of your configured currencies, but there is a solution !',
    '3DS verification failed, please try again.' => '3DS verification failed, please try again.',
    'Back to order page' => 'Back to order page',
    'One module, all payments methods.' => 'One module, all payments methods.',
    'Offer the widest range of payment methods: cards, PayPal, etc.' => 'Offer the widest range of payment methods: cards, PayPal, etc.',
    'Benefit from all PayPal expertise and advantages' => 'Benefit from all PayPal expertise and advantages',
    'Give access to relevant local payment methods for customers around the globe' => 'Give access to relevant local payment methods for customers around the globe',
    'Including:' => 'Including:',
    'Configure' => 'Configure',
    'Warning' => 'Warning',
    'You have selected your [PAYPAL_ACCOUNT] PayPal account to proceed to the payment.' => 'You have selected your [PAYPAL_ACCOUNT] PayPal account to proceed to the payment.',
    'Please wait, loading additional payment methods.' => 'Please wait, loading additional payment methods.',
    ...
    'Accept payments through PayPal buttons on your checkout page.' => 'Accept payments through PayPal buttons on your checkout page.',
    'Gold version shows better results on conversion rate' => 'Gold version shows better results on conversion rate',
    'Express Checkout Shortcut allows merging account creation and payment, to make your customers purchases effortless.' => 'Express Checkout Shortcut allows merging account creation and payment, to make your customers purchases effortless.',
    'Link to PrestaShop Checkout first' => 'Link to PrestaShop Checkout first',
    'Enabled' => 'Enabled',
    'Manage conversion rules' => 'Manage conversion rules',
    'Local payment methods' => 'Local payment methods',
    'Higher conversions' => 'Higher conversions',
    'Contact us' => 'Contact us',
    'Define the currency conversion rules' => 'Define the currency conversion rules',
    'Pending transaction' => 'Pending transaction',
    'Help for PrestaShop Checkout' => 'Help for PrestaShop Checkout',
    'Displaying this message has shown a better conversion rate and a raise of Average Order Value.' => 'Displaying this message has shown a better conversion rate and a raise of Average Order Value.',
    'Back' => 'Back',
    'Business information' => 'Business information',
    'Actions' => 'Actions',
    'Email already exist.' => 'Email already exist.',
    'One more thing : send documents to be fully approved by PayPal' => 'One more thing : send documents to be fully approved by PayPal',
    'The email is missing.' => 'The email is missing.',
    'in the meantime, you can sell now up to 500$ in card transactions.' => 'in the meantime, you can sell now up to 500$ in card transactions.',
    'Credit and Debit Cards' => 'Credit and Debit Cards',
    'Unfortunately, credit card payments cannot be processed for you at the moment. In the meantime, you can still receive payments via PayPal. Please proceed to some actions from your PayPal account, where you should have received a notification. If not, please contact PayPal help center.' => 'Unfortunately, credit card payments cannot be processed for you at the moment. In the meantime, you can still receive payments via PayPal. Please proceed to some actions from your PayPal account, where you should have received a notification. If not, please contact PayPal help center.',
    'Your PrestaShop account is linked to your PayPal account' => 'Your PrestaShop account is linked to your PayPal account',
    'in card transactions until your account is fully approved' => 'in card transactions until your account is fully approved',
    'Link to PayPal account' => 'Link to PayPal account',
    'Discount' => 'Discount',
    'Button configuration saved with success !' => 'Button configuration saved with success !',
    'Shipping costs, if any, will be estimated in basket total. Delivery method selected by default will be the one set in first position on Carriers page.' => 'Shipping costs, if any, will be estimated in basket total. Delivery method selected by default will be the one set in first position on Carriers page.',
    'Send it again' => 'Send it again',
    'Production mode enables you to collect your payments.' => 'Production mode enables you to collect your payments.',
    'The password is invalid.' => 'The password is invalid.',
    'except opposition here' => 'except opposition here',
    'Website' => 'Website',
    'If approval is pending or issues are encountered with the Integrated fields, you can activate these fields as a backup, only if Integrated fields are not available or deactivated. The fees are the same as PayPal payment method.' => 'If approval is pending or issues are encountered with the Integrated fields, you can activate these fields as a backup, only if Integrated fields are not available or deactivated. The fees are the same as PayPal payment method.',
    'Loading' => 'Loading',
    'There are no payment methods available. You can\'t receive payments from PayPal right now and your customers can\'t proceed to payments (anymore) via the payment methods provided by PrestaShop Checkout.' => 'There are no payment methods available. You can\'t receive payments from PayPal right now and your customers can\'t proceed to payments (anymore) via the payment methods provided by PrestaShop Checkout.',
    'Connect your PrestaShop Checkout account and link your PayPal Account or create one if needed' => 'Connect your PrestaShop Checkout account and link your PayPal Account or create one if needed',
    'What is the difference between Integrated Credit Card fields and PayPal branded Credit Card Fields ?' => 'What is the difference between Integrated Credit Card fields and PayPal branded Credit Card Fields ?',
    'Conversion rules' => 'Conversion rules',
    'Process unlimited card payments. You can accept either credit or debit card.' => 'Process unlimited card payments. You can accept either credit or debit card.',
    'The capability can no longer be used, but there are remediation steps to regain access to the corresponding functionality.' => 'The capability can no longer be used, but there are remediation steps to regain access to the corresponding functionality.',
    'Manage currencies' => 'Manage currencies',
    'Create your PrestaShop Checkout account' => 'Create your PrestaShop Checkout account',
    'Your account needs to be validated to accept PayPal payments. Please check your inbox for any email confirmation.' => 'Your account needs to be validated to accept PayPal payments. Please check your inbox for any email confirmation.',
    'Boost your conversion rate by displaying PayPal as the first choice in the list of payment methods' => 'Boost your conversion rate by displaying PayPal as the first choice in the list of payment methods',
    'You’ve got an email.' => 'You’ve got an email.',
    'Billing address' => 'Billing address',
    'PayPal button' => 'PayPal button',
    'FAQ' => 'FAQ',
    'Account declined FAQs' => 'Account declined FAQs',
    'First name' => 'First name',
    'Subtotal' => 'Subtotal',
    'Credit Card availability revoked' => 'Credit Card availability revoked',
    'Alternative Credit Card Fields activation' => 'Alternative Credit Card Fields activation',
    'Personal information' => 'Personal information',
    'Company estimated monthly turnover' => 'Company estimated monthly turnover',
    'White' => 'White',
    'Roundings settings to change' => 'Roundings settings to change',
    'Handling' => 'Handling',
    'Download PDF' => 'Download PDF',
    'Choose page location for messages' => 'Choose page location for messages',
    'Congrats ! You can start selling online now.' => 'Congrats ! You can start selling online now.',
    'Set up description' => 'Set up description',
    'Be careful, your roundings settings are not fully compatible with PrestaShop Checkout transaction processing. Some of the transactions could fail. But it is easy, your setting Round mode and Round type should be set on « Round up away from zero, when it is half way there » and « Round on each item » or click on the button bellow to make it automatically !' => 'Be careful, your roundings settings are not fully compatible with PrestaShop Checkout transaction processing. Some of the transactions could fail. But it is easy, your setting Round mode and Round type should be set on « Round up away from zero, when it is half way there » and « Round on each item » or click on the button bellow to make it automatically !',
    'TIPS' => 'TIPS',
    'Multistore detected' => 'Multistore detected',
    'Customize PayPal button' => 'Customize PayPal button',
    'Mr' => 'Mr',
    'per transaction depending on your country. ' => 'per transaction depending on your country. ',
    'Not available' => 'Not available',
    'Adjust your bank account' => 'Adjust your bank account',
    'Connect your PrestaShop account' => 'Connect your PrestaShop account',
    ...
    'PayPal algorithms automatically limit your fraud rate. There is a complete tool on PayPal to set specific rules and drive your performance concerning fraud and chargeback costs.' => 'PayPal algorithms automatically limit your fraud rate. There is a complete tool on PayPal to set specific rules and drive your performance concerning fraud and chargeback costs.',
    'Manage Activity' => 'Manage Activity',
    'Transaction type' => 'Transaction type',
    'Change payment methods order' => 'Change payment methods order',
    'Offer the widest range of payment methods: cards, PayPal, etc...' => 'Offer the widest range of payment methods: cards, PayPal, etc...',
    ' ) : we highly recommend to use these ones, by default. But you need PayPal full approval for accepting Credit Cards payment with the fields. You can see the status of this approval in the ' => ' ) : we highly recommend to use these ones, by default. But you need PayPal full approval for accepting Credit Cards payment with the fields. You can see the status of this approval in the ',
    'Please select the first shop to configure from the list below :' => 'Please select the first shop to configure from the list below :',
    'Test mode is turned on' => 'Test mode is turned on',
    'Reset password' => 'Reset password',
    'A confirmation email has been sent. Check your inbox and click on the link to activate your account.' => 'A confirmation email has been sent. Check your inbox and click on the link to activate your account.',
    'Use production mode' => 'Use production mode',
    'up to $500' => 'up to $500',
    'Integrated Credit Card Fields' => 'Integrated Credit Card Fields',
    'Change countries ISO Codes' => 'Change countries ISO Codes',
    'Payment methods acceptance' => 'Payment methods acceptance',
    'Create account' => 'Create account',
    'Test mode' => 'Test mode',
    'An error during configuration was detected. Please reset the PrestaShop Checkout module and configure it again.' => 'An error during configuration was detected. Please reset the PrestaShop Checkout module and configure it again.',
    'Read more' => 'Read more',
    'Log out' => 'Log out',
    'pending dispute(s)' => 'pending dispute(s)',
    'Terms and Conditions of Use of PrestaShop Checkout' => 'Terms and Conditions of Use of PrestaShop Checkout',
    'Date' => 'Date',
    'Each shop must be configured separately, even if you configure the same account on all of them.' => 'Each shop must be configured separately, even if you configure the same account on all of them.',
    'State' => 'State',
    'PrestaShop Checkout account' => 'PrestaShop Checkout account',
    'Authorize process holds all payments on customers’ account. Mark the order as « Shipped » or « Payment accepted » to capture payments. Local Payment Methods are not compatible with Authorize process.' => 'Authorize process holds all payments on customers’ account. Mark the order as « Shipped » or « Payment accepted » to capture payments. Local Payment Methods are not compatible with Authorize process.',
    'You need to connect to both PrestaShop and PayPal accounts to activate all payment methods' => 'You need to connect to both PrestaShop and PayPal accounts to activate all payment methods',
    'Language' => 'Language',
    'Tax' => 'Tax',
    'Integrated Credit Card fields provide the best payment experience you can find in PrestaShop. Well integrated in your checkout process, not branded, with the fewest number of fields, and lowest fee rates (see them on ' => 'Integrated Credit Card fields provide the best payment experience you can find in PrestaShop. Well integrated in your checkout process, not branded, with the fewest number of fields, and lowest fee rates (see them on ',
    'See below the transactions processed with PrestaShop Checkout, limited to the last 1000 to load them faster.' => 'See below the transactions processed with PrestaShop Checkout, limited to the last 1000 to load them faster.',
    'Reset' => 'Reset',
    'Configure your bank statements description' => 'Configure your bank statements description',
    'Pill' => 'Pill',
    'Note that you cannot collect payments with test mode' => 'Note that you cannot collect payments with test mode',
    'please check our list of customizable settings' => 'please check our list of customizable settings',
    'Business type' => 'Business type',
    'No confirmation email?' => 'No confirmation email?',
    'Country' => 'Country',
    'PayPal account' => 'PayPal account',
    'We recommend « Capture at shipping » if you are a lean manufacturer or a craft products seller' => 'We recommend « Capture at shipping » if you are a lean manufacturer or a craft products seller',
    'To test your payment method you can make a real transaction (prefer small amount), and once you have observed the money on your account, make a refund on the corresponding order page. Warning, you will not recover the fees.' => 'To test your payment method you can make a real transaction (prefer small amount), and once you have observed the money on your account, make a refund on the corresponding order page. Warning, you will not recover the fees.',
    'Errors' => 'Errors',
    'Starting from' => 'Starting from',
    'Account declined' => 'Account declined',
    'Adjust shape for all buttons' => 'Adjust shape for all buttons',
    'Your account needs further checks to accept Credit and Debit Cards payment.' => 'Your account needs further checks to accept Credit and Debit Cards payment.',
    'Recommended' => 'Recommended',
    'Competitive and transparent fees' => 'Competitive and transparent fees',
    'Additional information is required to complete background check. Please go on your www.paypal.com account and check the notification bell on the top right to know which documents are needed. It could be:' => 'Additional information is required to complete background check. Please go on your www.paypal.com account and check the notification bell on the top right to know which documents are needed. It could be:',
    'Help' => 'Help',
    'Submit idea' => 'Submit idea',
    'Fraud tool' => 'Fraud tool',
    'Change rounding settings' => 'Change rounding settings',
    'Define PayPal express checkout flow' => 'Define PayPal express checkout flow',
    'Choose page location' => 'Choose page location',
    'PayPal Branded Credit Card Fields' => 'PayPal Branded Credit Card Fields',
    'Log in with your PrestaShop Checkout account' => 'Log in with your PrestaShop Checkout account',
    'Please contact PayPal Customer Service' => 'Please contact PayPal Customer Service',
    'Know more about my account approval' => 'Know more about my account approval',
    'Error, try later.' => 'Error, try later.',
    'Available' => 'Available',
    'I agree to the ' => 'I agree to the ',
    'Details for Bank statements' => 'Details for Bank statements',
    '(merchant ID {0})' => '(merchant ID {0})',
    'pending' => 'pending',
    'Additional Details' => 'Additional Details',
    'Limit your fraud rate' => 'Limit your fraud rate',
    'Bank account' => 'Bank account',
    'Mrs' => 'Mrs',
    'Credit Card availability suspended' => 'Credit Card availability suspended',
    'As soon as PayPal gets all your documents, you\'ll have to wait 48h for final approval.' => 'As soon as PayPal gets all your documents, you\'ll have to wait 48h for final approval.',
    'All transactions' => 'All transactions',
    'You can process' => 'You can process',
    'Sign in or login to provide every payment method to your customer.' => 'Sign in or login to provide every payment method to your customer.',
    'Activation status' => 'Activation status',
    'Forgot password?' => 'Forgot password?',
    'Settings updated !' => 'Settings updated !',
    'An error occured, the PayPal sign up or login window can\'t be opened. Please wait a bit and click again.' => 'An error occured, the PayPal sign up or login window can\'t be opened. Please wait a bit and click again.',
    'The email address is badly formatted.' => 'The email address is badly formatted.',
    'Credit Card information, bank account information and ID card' => 'Credit Card information, bank account information and ID card',
    'By submitting this form, I agree that the data provided may be collected by PrestaShop S.A to create your PrestaShop Checkout account. By creating your account, you will receive commercial prospecting from PrestaShop' => 'By submitting this form, I agree that the data provided may be collected by PrestaShop S.A to create your PrestaShop Checkout account. By creating your account, you will receive commercial prospecting from PrestaShop',
    'Logging out will deactivate all payment methods. You will no longer be able to receive payments with PrestaShop Checkout.' => 'Logging out will deactivate all payment methods. You will no longer be able to receive payments with PrestaShop Checkout.',
    'Choose page location for buttons' => 'Choose page location for buttons',
    'You can choose the type of credit card fields only if Credit card is activated in « Customize checkout experience » tab.' => 'You can choose the type of credit card fields only if Credit card is activated in « Customize checkout experience » tab.',
    'Postcode' => 'Postcode',
    'Suspended' => 'Suspended',
    'Background check is currently undergoing' => 'Background check is currently undergoing',
    'Last name' => 'Last name',
    'Sign up on order page' => 'Sign up on order page',
    'Order Id' => 'Order Id',
    'Fill out the form to complete registration:' => 'Fill out the form to complete registration:',
    ...
    'Setup fraud tool' => 'Setup fraud tool',
    'Live' => 'Live',
    'Blue' => 'Blue',
    'Business phone' => 'Business phone',
    'Gold' => 'Gold',
    'Use another account' => 'Use another account',
    'You are now logged in with your' => 'You are now logged in with your',
    'An agency' => 'An agency',
    'You\'re all set !' => 'You\'re all set !',
    'Information needed' => 'Information needed',
    'Your rounding settings are now fully compatible' => 'Your rounding settings are now fully compatible',
    'This feature availability is based on eligibility criteria.' => 'This feature availability is based on eligibility criteria.',
    'Once you are done with the first shop, you can configure the others: select them one by one with the shop selector, in the horizontal menu.' => 'Once you are done with the first shop, you can configure the others: select them one by one with the shop selector, in the horizontal menu.',
    'Continue' => 'Continue',
    'Tips' => 'Tips',
    'The capability can no longer be used and there are no remediation steps available to regain the functionality.' => 'The capability can no longer be used and there are no remediation steps available to regain the functionality.',
    'Type' => 'Type',
    'Before commission' => 'Before commission',
    'It can take several days. If further information is needed, you will be notified. Please check your emails or your notification bell on the top right of your www.paypal.com account and follow the instructions.' => 'It can take several days. If further information is needed, you will be notified. Please check your emails or your notification bell on the top right of your www.paypal.com account and follow the instructions.',
    'Change currencies ISO Codes' => 'Change currencies ISO Codes',
    'Are you sure you want to logout ?' => 'Are you sure you want to logout ?',
    'The password is missing.' => 'The password is missing.',
    'You can manage the currencies of your PayPal account. Ideally, make them match with the available currencies of your store.' => 'You can manage the currencies of your PayPal account. Ideally, make them match with the available currencies of your store.',
    'You can process a limited amount in card transactions.' => 'You can process a limited amount in card transactions.',
    'Activate payment methods' => 'Activate payment methods',
    'We sent you an email with instructions to reset your password. Please check your inbox.' => 'We sent you an email with instructions to reset your password. Please check your inbox.',
    'Unfortunately, you have revoked PrestaShop Checkout permissions. Credit card payments cannot be processed for you. You can still receive payments via PayPal. Please, log out your PayPal account just below and link your account giving permission again. You can contact PayPal help center to have more information about your account.' => 'Unfortunately, you have revoked PrestaShop Checkout permissions. Credit card payments cannot be processed for you. You can still receive payments via PayPal. Please, log out your PayPal account just below and link your account giving permission again. You can contact PayPal help center to have more information about your account.',
    'No faq available. Try later.' => 'No faq available. Try later.',
    'Design smart payment buttons' => 'Design smart payment buttons',
    'You can choose the short or long description that appears on your customer\'s bank statements. Let\'s make them sure to understand their transaction!' => 'You can choose the short or long description that appears on your customer\'s bank statements. Let\'s make them sure to understand their transaction!',
    'Email validation needed' => 'Email validation needed',
    'No redirection when paying by credit card' => 'No redirection when paying by credit card',
    'We cannot process credit card payments for you at the moment.' => 'We cannot process credit card payments for you at the moment.',
    'All custom themes might not be fully compatible. To avoid potential integration issues on payment page,' => 'All custom themes might not be fully compatible. To avoid potential integration issues on payment page,',
    'We have received the confirmation from PayPal. You can now process all card transactions with no limits.' => 'We have received the confirmation from PayPal. You can now process all card transactions with no limits.',
    'The email is not found.' => 'The email is not found.',
    'Payment preferences' => 'Payment preferences',
    'Sign in' => 'Sign in',
    'Manage bank account' => 'Manage bank account',
    'Log in or sign up to PayPal' => 'Log in or sign up to PayPal',
    'Go to PayPal' => 'Go to PayPal',
    'Pending approval' => 'Pending approval',
    'Couldn\'t find any answer to your question?' => 'Couldn\'t find any answer to your question?',
    'Disabled' => 'Disabled',
    'I accept the terms of use' => 'I accept the terms of use',
    'Limited to $500' => 'Limited to $500',
    'Within your PayPal account, you can add a bank account to be beneficiary of your money transfer.' => 'Within your PayPal account, you can add a bank account to be beneficiary of your money transfer.',
    'Choose label' => 'Choose label',
    'Approval pending' => 'Approval pending',
    'Direct Sale' => 'Direct Sale',
    'in the meantime, you will only accept credit cards payments thought the PayPal branded credit card fields' => 'in the meantime, you will only accept credit cards payments thought the PayPal branded credit card fields',
    'Category page' => 'Category page',
    'See the full list of transactions on your PayPal account' => 'See the full list of transactions on your PayPal account',
    ...
    'Learn more about managing your data and rights.' => 'Learn more about managing your data and rights.',
    'Pay in 4x, save credit cards, authorize mode, send payments direct link... and more to come! Let us know what you would love to be added to this module: any new feature or behavior improvement!' => 'Pay in 4x, save credit cards, authorize mode, send payments direct link... and more to come! Let us know what you would love to be added to this module: any new feature or behavior improvement!',
    'Authentication' => 'Authentication',
    'A freelancer' => 'A freelancer',
    'Go to the dispute management platform' => 'Go to the dispute management platform',
    'Send my legal documents now' => 'Send my legal documents now',
    'Save' => 'Save',
    'Send your legal documents to PayPal : ' => 'Send your legal documents to PayPal : ',
    'Payer action required' => 'Payer action required',
    '10 payment methods included all-in-one' => '10 payment methods included all-in-one',
    'Customer' => 'Customer',
    'Email' => 'Email',
    'Rectangle' => 'Rectangle',
    'Unfortunately, credit card payments cannot be processed for you at the moment. You will be able to reapply after 90 days. In the meantime, you can still receive payments via PayPal' => 'Unfortunately, credit card payments cannot be processed for you at the moment. You will be able to reapply after 90 days. In the meantime, you can still receive payments via PayPal',
    'Let\'s choose the conversion rules for any transaction in a currency other than those activated on your account, should they be automatically converted or request your validation.' => 'Let\'s choose the conversion rules for any transaction in a currency other than those activated on your account, should they be automatically converted or request your validation.',
    'Select background color' => 'Select background color',
    'Partially completed' => 'Partially completed',
    'pending transaction(s)' => 'pending transaction(s)',
    'Local payment buttons' => 'Local payment buttons',
    'Business category' => 'Business category',
    'Thank you, close this message' => 'Thank you, close this message',
    'Are you' => 'Are you',
    'Sign up' => 'Sign up',
    'Pay with' => 'Pay with',
    'Business subcategory' => 'Business subcategory',
    'https://www.prestashop.com/en/prestashop-checkout' => 'https://www.prestashop.com/en/prestashop-checkout',
    'Password' => 'Password',
    'Address' => 'Address',
    'Currencies' => 'Currencies',
    'Choose page location for banners' => 'Choose page location for banners',
    'Warning : the currencies you have activated : {0} are not currently supported by PrestaShop Checkout. Please deactivate {0} for PrestaShop Checkout in your' => 'Warning : the currencies you have activated : {0} are not currently supported by PrestaShop Checkout. Please deactivate {0} for PrestaShop Checkout in your',
    'Need help? Find here the documentation of this module' => 'Need help? Find here the documentation of this module',
    'account' => 'account',
    'For more informations about your fees please visit this page:' => 'For more informations about your fees please visit this page:',
    'Synchronization between your store and your PayPal account is in progress. Please wait.' => 'Synchronization between your store and your PayPal account is in progress. Please wait.',
    'Match currencies' => 'Match currencies',
    'Store name' => 'Store name',
    'Credit card' => 'Credit card',
    'As for local payment methods, buttons will be displayed according to the purchase context: country, amount, device, etc.' => 'As for local payment methods, buttons will be displayed according to the purchase context: country, amount, device, etc.',
    'Black' => 'Black',
    'Shipping' => 'Shipping',
    ...
    'Onboarding almost done!' => 'Onboarding almost done!',
    'By submitting this form, I agree that the data provided may be collected by PrestaShop S.A to permit (i) the use of our services (ii) to improve your customer experience. Your data can be transmitted to our partner Paypal if you do not already have an account.' => 'By submitting this form, I agree that the data provided may be collected by PrestaShop S.A to permit (i) the use of our services (ii) to improve your customer experience. Your data can be transmitted to our partner Paypal if you do not already have an account.',
    'transaction(s)' => 'transaction(s)',
    'Payment methods activation' => 'Payment methods activation',
    'Capture at shipping' => 'Capture at shipping',
    'Account Linking in progress' => 'Account Linking in progress',
    'Link your PayPal account' => 'Link your PayPal account',
    'Silver' => 'Silver',
    'Availability' => 'Availability',
    'Advanced settings' => 'Advanced settings',
    'When to use PayPal branded Credit Card fields ?' => 'When to use PayPal branded Credit Card fields ?',
    'You have exceeded the maximum number of payment attempts.' => 'You have exceeded the maximum number of payment attempts.',
    'The selected payment method does not support this type of transaction. Please choose another payment method or contact support for assistance.' => 'The selected payment method does not support this type of transaction. Please choose another payment method or contact support for assistance.',
    'This payment method seems not working currently, please try another.' => 'This payment method seems not working currently, please try another.',
    'This payment method declined transaction, please try another.' => 'This payment method declined transaction, please try another.',
    'Your PayPal account is locked or closed, please try another.' => 'Your PayPal account is locked or closed, please try another.',
    'The transaction was blocked by Fraud Protection settings.' => 'The transaction was blocked by Fraud Protection settings.',
    'Your card cannot be used to pay in our country, please try another payment method.' => 'Your card cannot be used to pay in our country, please try another payment method.',
    'You are not allowed to pay with this PayPal account, please try another.' => 'You are not allowed to pay with this PayPal account, please try another.',
    'Card payment cannot be processed at the moment, please use another payment method.' => 'Card payment cannot be processed at the moment, please use another payment method.',
    'You are not allowed to pay with this payment method, please try another.' => 'You are not allowed to pay with this payment method, please try another.',
    'Make this card favorite / default ' => 'Make this card favorite / default ',
    'Securely store payment details for future purchases' => 'Securely store payment details for future purchases',
    'Make this account favorite / default ' => 'Make this account favorite / default ',
    'Make this my preferred payment method' => 'Make this my preferred payment method',
    'This payment method has been saved to your account.' => 'This payment method has been saved to your account.',
    'This payment method has been saved to your account and defined as favorite for future purchases.' => 'This payment method has been saved to your account and defined as favorite for future purchases.',
    'Delete' => 'Delete',
    'The payment is not valid: the amount is not eligible.' => 'The payment is not valid: the amount is not eligible.',
    'Pay later with invoice' => 'Pay later with invoice',
...
Once you enable the "%generate_rtl_label%" option, any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.',
  ...
  array (
    ...
    'The override file %1$s conflicts with an existing override in %2$s.' => 'The override file %1$s conflicts with an existing override in %2$s.',
...
Thanks for your patience.',
  ...
  array (
    ...
    'You can\'t transform your account into a customer account, because a registered customer with the same email already exists.' => 'You can\'t transform your account into a customer account, because a registered customer with the same email already exists.',
